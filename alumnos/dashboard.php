...
<body class="student-portal bg-light">

<div class="container py-4">
    
    <!-- Navbar Superior -->
    <div class="d-flex justify-content-between mb-4 align-items-center bg-white p-3 rounded-4 shadow-sm animate-fade-in" style="animation-delay: 0.1s;">
        <div class="d-flex align-items-center">
            <div class="bg-success text-white rounded-circle d-flex justify-content-center align-items-center me-3" style="width: 45px; height: 45px; font-size: 1.5rem;">
                🎓
            </div>
            <div>
                <h5 class="m-0 fw-bold text-dark">Portal del Alumno</h5>
                <span class="text-muted small"><?php echo htmlspecialchars($alumno['nivel'] . ' | ' . $alumno['grado'] . 'º ' . $alumno['grupo']); ?></span>
            </div>
        </div>
        <div>
            <span class="me-3 fw-bold text-success d-none d-md-inline">👋 Hola, <?php echo htmlspecialchars($alumno['nombre']); ?></span>
            <a href="../auth/cerrar_sesion_alumno.php" class="btn btn-sm btn-outline-danger rounded-pill px-3 shadow-sm"><i class="bi bi-box-arrow-right me-1"></i>Salir</a>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4 d-flex flex-column gap-4">
            ...
            <div class="card bg-success text-white rounded-4 border-0 shadow-sm animate-fade-in" style="animation-delay: 0.2s;">
                <div class="card-body p-4 position-relative overflow-hidden">
                    <i class="bi bi-award-fill position-absolute text-white opacity-25" style="font-size: 8rem; right: -20px; top: -10px;"></i>
            ...
            <div class="card shadow-sm rounded-4 border-0 animate-fade-in" style="animation-delay: 0.3s;">
                <div class="card-body p-4">
                    <h6 class="fw-bold text-secondary mb-3"><i class="bi bi-calendar-check-fill text-primary me-2"></i>Récord de Asistencias</h6>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="text-muted"><i class="bi bi-check-circle-fill text-success me-2"></i>Asistencias</span>
                        <span class="fw-bold fs-5"><?php echo $asistencias_stats['Presente']; ?></span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="text-muted"><i class="bi bi-exclamation-circle-fill text-warning me-2"></i>Retardos</span>
            ...
            <div class="d-grid gap-3 animate-fade-in" style="animation-delay: 0.4s;">
                <a href="../calificaciones/mis_calificaciones.php" class="btn btn-primary btn-lg rounded-4 shadow-sm d-flex align-items-center justify-content-between">
                    <span><i class="bi bi-journal-text me-2"></i>Historial Detallado</span>
                    <i class="bi bi-arrow-right"></i>
                </a>
                <a href="../calificaciones/generar_boleta_pdf.php?id=<?php echo $id_alumno; ?>" target="_blank" class="btn btn-outline-secondary rounded-4 shadow-sm d-flex align-items-center justify-content-between">
        ...
        <div class="col-lg-8 animate-fade-in" style="animation-delay: 0.5s;">
            <div class="card shadow-sm rounded-4 border-0 h-100">
                <div class="card-header bg-transparent border-0 pt-4 pb-2 px-4 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold m-0"><i class="bi bi-megaphone-fill text-info me-2"></i>Avisos y Comunicados</h5>
                </div>
                <div class="card-body p-4 pt-2">
                    <?php if ($res_avisos && $res_avisos->num_rows > 0): ?>
                        <div class="d-flex flex-column gap-3">
                            <?php while ($aviso = $res_avisos->fetch_assoc()): ?>
                                <div class="p-4 border rounded-4 bg-info bg-opacity-10 border-info border-opacity-25 shadow-sm position-relative">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <h5 class="fw-bold text-dark m-0"><?php echo htmlspecialchars($aviso['titulo']); ?></h5>
                                        <span class="badge bg-primary bg-opacity-75 rounded-pill px-3 py-2"><i class="bi bi-clock me-1"></i><?php echo date('d M', strtotime($aviso['fecha_publicacion'])); ?></span>
                                    </div>
                                    <p class="text-muted mb-3" style="font-size: 0.95rem;">
                                        <?php echo nl2br(htmlspecialchars($aviso['mensaje'])); ?>
                                    </p>
                                    <div class="small text-body-secondary fw-medium">
                                        <i class="bi bi-person-fill text-info me-1"></i>Enviado por: <?php echo htmlspecialchars($aviso['autor']); ?>
                                    </div>
                                </div>
                            <?php
    endwhile; ?>
