...
<body class="auth-docente">
    ...
    <div class="login-container animate-fade-in">
        ...
        <div class="text-center mb-4">
            <div class="d-inline-flex align-items-center justify-content-center bg-info bg-opacity-10 text-info rounded-circle mb-3"
            ...
            <div class="mb-4">
                ...
                <div class="input-group input-group-lg shadow-sm">
                    ...
                    <input type="email" class="form-control border-start-0 ps-0" id="correo" name="correo"
                        placeholder="profesor@escuela.edu" required>
                </div>
            </div>
        ...
        <div class="text-center pt-3 border-top">
            <a href="login.php"
                class="text-decoration-none text-primary fw-medium d-inline-block mb-3 px-3 py-2 rounded-pill bg-primary bg-opacity-10">
