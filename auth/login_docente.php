    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (btnToggle) {
                ...
                themeIcon.innerHTML = currentTheme === 'dark' ? '<i class="bi bi-sun-fill text-warning"></i>' : '<i class="bi bi-moon-stars-fill text-info"></i>';
                ...
                btnToggle.addEventListener('click', () => {
                    ...
                    themeIcon.innerHTML = newTheme === 'dark' ? '<i class="bi bi-sun-fill text-warning"></i>' : '<i class="bi bi-moon-stars-fill text-info"></i>';
                });
            }
        });
    </script>
...
<div class="login-container animate-fade-in">
    ...
    <div class="text-center mb-4">
        ...
        <h3 class="text-info fw-bold">Portal de Docentes</h3>
        <p class="text-muted small">Ingresa para gestionar calificaciones.</p>
    </div>
    ...
    <form action="procesar_login_docente.php" method="POST">
        <div class="mb-4">
            ...
            <div class="input-group input-group-lg shadow-sm">
                ...
                <input type="email" class="form-control border-start-0 ps-0" id="correo" name="correo" placeholder="profesor@escuela.edu" required>
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-info text-white w-100 btn-lg mt-2 mb-4 rounded-pill shadow">
            Ingresar <i class="bi bi-box-arrow-in-right ms-2"></i>
        </button>
    </form>
    
    <div class="text-center pt-3 border-top">
        <a href="login.php" class="text-decoration-none text-primary fw-medium d-inline-block mb-3 px-3 py-2 rounded-pill bg-primary bg-opacity-10">
