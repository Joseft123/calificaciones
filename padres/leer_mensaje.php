            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden mb-4 d-flex flex-column" style="height: 75vh;">
                    ...
                    <div class="card-header chat-header p-3 d-flex align-items-center shadow-sm z-1">
                        <div class="bg-gradient-success text-white rounded-circle d-flex justify-content-center align-items-center me-3 shadow-sm flex-shrink-0" style="width: 50px; height: 50px; font-size: 1.2rem; font-weight: bold;">
                        ...
                        <div class="card-footer bg-body p-3 border-top reply-box z-1 shadow-sm">
                            <form action="leer_mensaje.php?id=<?php echo $id_mensaje; ?>" method="POST" class="needs-validation m-0 d-flex gap-2" novalidate id="replyForm">
                                ...
                                <div class="flex-grow-1 position-relative">
                                    <textarea name="respuesta_texto" id="replyTextarea" class="form-control form-control-lg bg-body-tertiary border-0 px-4 py-3" rows="1" style="max-height: 120px; overflow-y: auto;" placeholder="Escribe un mensaje..." required></textarea>
                                </div>
