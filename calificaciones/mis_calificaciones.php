            ...
            <div class="container-fluid px-2">
                <div class="d-flex align-items-center w-100 justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <button class="theme-toggle-btn btn btn-outline-secondary btn-sm rounded-circle shadow-sm me-2 premium-icon-btn d-flex justify-content-center align-items-center" id="btnThemeToggle" title="Cambiar Tema">
                            <span id="themeIcon">🌙</span>
                        </button>
                        <a href="../auth/cerrar_sesion_alumno.php" class="btn btn-sm btn-danger rounded-pill px-3 shadow-sm d-flex justify-content-center align-items-center"><i class="bi bi-box-arrow-right me-1"></i>Salir</a>
                    </div>
                </div>
            </div>
        </nav>
